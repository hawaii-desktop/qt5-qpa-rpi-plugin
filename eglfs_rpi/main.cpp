...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QPA.QPlatformIntegrationFactoryInterface.5.2" FILE "eglfs_rpi.json")
public:
...
{
    Q_UNUSED(paramList);
    if (!system.compare(QLatin1String("eglfs_rpi"), Qt::CaseInsensitive))
